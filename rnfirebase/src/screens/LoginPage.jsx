    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={{ flex: 1, justifyContent: "center" }}>
                ...
                <TouchableOpacity style={[styles.btn, {backgroundColor:"lightskyblue"}]} onPress={() => navigation.navigate('RegisterPage')}>
                    <Text style={styles.btnText}>Hesabınız Yok Mu?</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )

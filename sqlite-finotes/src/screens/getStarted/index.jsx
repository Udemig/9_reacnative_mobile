      ...
      <View style={defaultScreenStyle.container}>
        ...
        <View style={{ flex: 1, padding: 5 }}>
          <View style={{ flex: 2, }}>
            ...
            <TextDescription description={"Notely is the world's safest, largest and most intelligent digital notebook. Join over 10M+ users who are already using Notely."} />
          </View>
